...
Alternatively, you can only download the pairwise passage data and generate your own embeddings: http://treccar.cs.unh.edu/appendix/qs3m_dataset_compressed/qs3m_data_min.tar.gz. 
