...
tfidf_vec_dict = {}
lda_tm_topic_dist = {}
num_topics=300 #for topic model
...
def main():
    ...
    parser.add_argument('-tm', '--topic_model', default="/home/sk1105/sumanta/CATS_data/topic_model/topic_model_half-y1train-qry-attn-t300.model")
    parser.add_argument('-td', '--token_dict', default="/home/sk1105/sumanta/CATS_data/topic_model/half-y1train-qry-attn-lda-tm-t300.tokendict")
