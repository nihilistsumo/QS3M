...
def main():
    ...
    parser.add_argument('-tq1', '--test_qids1', default="by1train-context-title-qids.npy") #change
    parser.add_argument('-tqv1', '--test_qvecs1', default="by1train-context-title-qvecs.npy") #change
    ...
    parser.add_argument('-tq2', '--test_qids2', default="by1test-context-title-qids.npy") #change
    parser.add_argument('-tqv2', '--test_qvecs2', default="by1test-context-title-qvecs.npy") #change

    parser.add_argument('-mt', '--model_type', default="scaled") #cats, scaled, abl
    parser.add_argument('-mp', '--model_path', default="/home/sk1105/sumanta/cats_deploy/model/saved_models/cavs_title_b32_l0.001_i10.model") #change
