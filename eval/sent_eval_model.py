...
def main():
    ...
    parser.add_argument('-tq1', '--test_qids1', default="by1test-context-leadpara-qids.npy") #change
    parser.add_argument('-tqv1', '--test_qvecs1', default="by1test-context-leadpara-qvecs.npy") #change
    ...
    parser.add_argument('-tq2', '--test_qids2', default="by1train-context-leadpara-qids.npy") #change
    parser.add_argument('-tqv2', '--test_qvecs2', default="by1train-context-leadpara-qvecs.npy") #change

    parser.add_argument('-cp', '--cats_path', default="/home/sk1105/sumanta/cats_deploy/model/saved_models/cats_leadpara_b32_l0.00001_i4.model") #change
    ...
    parser.add_argument('-mp', '--model_path', default="/home/sk1105/sumanta/cats_deploy/model/saved_models/sentcats_leadpara_b32_l0.0001_i4.model") #change
