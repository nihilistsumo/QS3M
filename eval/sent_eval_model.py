...
def main():
    ...
    parser.add_argument('-tp', '--test_pids', default="by1train-allpos-pids-sentwise.npy")
    parser.add_argument('-tv', '--test_pvecs', default="by1train-allpos-paravecs-sentwise.npy")
