...
def main():
    ...
    parser.add_argument('-tp', '--train_ptext', default="/home/sk1105/sumanta/trec_dataset/benchmarkY1/benchmarkY1-train-nodup/by1train_paratext/by1train_paratext.tsv")
    ...
    parser.add_argument('-td', '--token_dict_out', default="/home/sk1105/sumanta/CATS_data/tmp.tokendict")
    parser.add_argument('-mo', '--model_out', default="/home/sk1105/sumanta/CATS_data/tmp.model")
