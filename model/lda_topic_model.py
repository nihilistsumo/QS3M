...
def main():
    ...
    parser.add_argument('-nt', '--num_topics', type=int, default=500)
    parser.add_argument('-up', '--update', type=int, default=0)
    parser.add_argument('-ps', '--passes', type=int, default=3)
    parser.add_argument('-td', '--token_dict_out', default="/home/sk1105/sumanta/CATS_data/topic_model/half-y1train-qry-attn-lda-tm-t500.tokendict")
    parser.add_argument('-mo', '--model_out', default="/home/sk1105/sumanta/CATS_data/topic_model/topic_model_half-y1train-qry-attn-t500.model")
