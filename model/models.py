...
def main():
    ...
    parser.add_argument('-trq', '--train_qids', default="half-y1train-context-title-qids.npy")
    parser.add_argument('-tq', '--test_qids', default="by2test-context-title-qids.npy")
    parser.add_argument('-trqv', '--train_qvecs', default="half-y1train-context-title-qvecs.npy")
