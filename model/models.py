...
def main():
    ...
    parser.add_argument('-tp', '--test_pids', default="by2test-allpos-pids.npy")
    parser.add_argument('-trv', '--train_pvecs', default="half-y1train-qry-attn-paravecs.npy")
    parser.add_argument('-tv', '--test_pvecs', default="by2test-allpos-paravecs.npy")
    parser.add_argument('-trq', '--train_qids', default="half-y1train-context-meanall-qids.npy")
    parser.add_argument('-tq', '--test_qids', default="by2test-context-meanall-qids.npy")
    parser.add_argument('-trqv', '--train_qvecs', default="half-y1train-context-meanall-qvecs.npy")
