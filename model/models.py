...
def main():
    ...
    parser.add_argument('-trp', '--train_pids', default="raw_bert_embeds/y1train-raw-bert-all-pids.npy")
    parser.add_argument('-trv', '--train_pvecs', default="raw_bert_embeds/y1train-raw-bert-all-paravecs.npy")
    parser.add_argument('-trq', '--train_qids', default="raw_bert_embeds/half-y1train-qry-attn-raw-bert-cls-context-leadpara-qids.npy")
    parser.add_argument('-trqv', '--train_qvecs', default="raw_bert_embeds/half-y1train-qry-attn-raw-bert-cls-context-leadpara-qvecs.npy")

    parser.add_argument('-qt', '--qry_attn_test', default="by1test-qry-attn-bal-allpos.tsv")
    parser.add_argument('-tp', '--test_pids', default="raw_bert_embeds/by1test-raw-bert-all-pids.npy")
    parser.add_argument('-tv', '--test_pvecs', default="raw_bert_embeds/by1test-raw-bert-all-paravecs.npy")
    parser.add_argument('-tq', '--test_qids', default="raw_bert_embeds/by1test-raw-bert-cls-context-leadpara-qids.npy")
    parser.add_argument('-tqv', '--test_qvecs', default="raw_bert_embeds/by1test-raw-bert-cls-context-leadpara-qvecs.npy")
    ...
    parser.add_argument('-ct', '--cats_type', default="cavs")
