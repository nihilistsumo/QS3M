...
def main():
    ...
    parser.add_argument('-trq', '--train_qids', default="half-y1train-qry-attn-context-meanall-qids.npy")
    parser.add_argument('-tq', '--test_qids', default="by1test-context-meanall-qids.npy")
    parser.add_argument('-trqv', '--train_qvecs', default="half-y1train-qry-attn-context-meanall-qvecs.npy")
    ...
    parser.add_argument('-cp', '--cats_path', default='/home/sk1105/sumanta/cats_deploy/model/saved_models/cats_meanall_b32_l0.00001_i4.model')
