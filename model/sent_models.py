...
def main():
    ...
    parser.add_argument('-qtr', '--qry_attn_train', default="by1train-qry-attn-bal-allpos.tsv")
    parser.add_argument('-qt', '--qry_attn_test', default="by1test-qry-attn-bal-allpos-for-eval.tsv")
    parser.add_argument('-trp', '--train_pids', default="by1train-allpos-pids-sentwise.npy")
    parser.add_argument('-tp', '--test_pids', default="by1test-allpos-for-eval-pids-sentwise.npy")
    parser.add_argument('-trv', '--train_pvecs', default="by1train-allpos-paravecs-sentwise.npy")
    parser.add_argument('-tv', '--test_pvecs', default="by1test-allpos-for-eval-paravecs-sentwise.npy")
    parser.add_argument('-trq', '--train_qids', default="by1train-context-qids.npy")
    ...
    parser.add_argument('-np', '--param_n', type=int, default=128)
